...
export function AccordionHeader({
  ...
  return (
    <motion.div
      data-active={isActive || undefined}
      className={cn(
        "p-4 cursor-pointer w-full transition-all font-semibold  text-neutral-500   data-[active]:bg-zinc-800/70  hover:bg-neutral-100 hover:text-black flex justify-between gap-2 items-center",
        className
      )}
      onClick={handleClick}
    >
    ...
    <AnimatePresence initial={true}>
      {isActive && (
        <motion.div
          ...
          className={cn(
            " bg-neutral-100 px-2 data-[active]:bg-zinc-800/70 text-black ",
            className
          )}
        >
          <motion.div
